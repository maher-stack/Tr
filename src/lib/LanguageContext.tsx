...
const dictionary: Record<Language, Record<string, string>> = {
  en: {
    ...
    plan_pro_desc: "For professionals and small teams with advanced protection and reminders.",
    plan_pro_price: "$4.99",
  ...
  ar: {
    ...
    plan_pro_desc: "للمحترفين والفرق الصغيرة مع ميزات حماية وتذكير متقدمة.",
    plan_pro_price: "$4.99",
