...
const dictionary: Record<Language, Record<string, string>> = {
  en: {
    ...
    pricing_desc: "Start for free and upgrade when you need advanced features and instant synchronization.",
    plan_free_name: "Basic",
    plan_free_desc: "Perfect for individuals tracking personal subscriptions.",
    plan_free_price: "Free",
    plan_pro_name: "Professional (Pro)",
    plan_pro_desc: "For professionals wanting advanced features, reports and insights.",
    plan_pro_price: "$3.00",
    plan_pro_period: "/ monthly",
    plan_ultimate_name: "Ultimate (Team)",
    plan_ultimate_desc: "Includes everything plus full access, up to the Employee Management page.",
    plan_ultimate_price: "$5.50",
    plan_ultimate_period: "/ monthly",
    plan_current: "Current Plan",
    plan_previous: "Previous Plan",
    plan_upgrade: "Upgrade Now",
    plan_active: "Active (Current Plan)",
    best_value: "Best Value",
    feature_limit: "Add up to 3 active subscriptions",
    feature_dashboard: "Interactive expense dashboard",
    feature_calc: "Access to main dashboard & calculators",
    feature_categories: "Category-based expense distribution",
    feature_unlimited: "Unlimited subscriptions",
    feature_all_pages: "Access to all pages and deep analytics",
    feature_exports: "Export reports (PDF, CSV & JSON)",
    feature_team: "Manage workspace with teammates",
    feature_alerts: "Advanced WhatsApp & Telegram alerts",
  ...
  ar: {
    ...
    // Pricing Page
    pricing_title: "اختر الخطة المناسبة لك",
    pricing_desc: "ابدأ مجاناً وقم بالترقية عندما تحتاج إلى المزيد من الميزات المتقدمة والمزامنة الفورية.",
    plan_free_name: "الأساسية",
    plan_free_desc: "مثالية للأفراد لتتبع الاشتراكات الشخصية الفردية.",
    plan_free_price: "مجانًا",
    plan_pro_name: "الاحترافية (Pro)",
    plan_pro_desc: "مثالية للمستخدمين الراغبين بميزات تتبع وتحليلات متقدمة دون إدارة الفريق.",
    plan_pro_price: "$3.00",
    plan_pro_period: "/ شهرياً",
    plan_ultimate_name: "القصوى الشاملة (Ultimate)",
    plan_ultimate_desc: "الوصول اللامحدود لكامل مميزات الموقع الفائقة وتفعيل صفحة إدارة الموظفين بالكامل.",
    plan_ultimate_price: "$5.50",
    plan_ultimate_period: "/ شهرياً",
    plan_current: "الخطة الحالية",
    plan_previous: "الخطة السابقة",
    plan_upgrade: "اشترك الآن ترقية فورية",
    plan_active: "مفعل (الخطة الحالية)",
    best_value: "أفضل قيمة",
    feature_limit: "إضافة حتى 3 اشتراكات نشطة",
    feature_dashboard: "لوحة تحكم تفاعلية للمصاريف الشهرية",
    feature_calc: "الوصول للصفحة الرئيسية والحواسب التفاعلية",
    feature_categories: "توزيع المصاريف حسب تصنيف الفئات",
    feature_unlimited: "عدد غير محدود من الاشتراكات",
    feature_all_pages: "الوصول لجميع الصفحات والميزات المعمقة",
    feature_exports: "تصدير التقارير المتنوعة (PDF & CSV & JSON)",
    feature_team: "إدارة حسابات متعددة مع أعضاء الفريق",
    feature_alerts: "قنوات تنبيهات واتساب وتليجرام متقدمة ودعم فني",
